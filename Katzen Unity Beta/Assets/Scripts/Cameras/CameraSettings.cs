...
using UnityEngine;
    ...
    public class CameraSettings : MonoBehaviour
    {
        ...
        void Reset()
        {
            ...
            JogMovimentoRigid playerController = FindObjectOfType<JogMovimentoRigid>();
            if (playerController != null && playerController.name == "Katzen Character")
            {
                follow = playerController.transform;

                lookAt = follow.Find("AlvoCabeca");
